...
namespace Payment.Controllers
{
    public class ReceiversController : Controller
    {
        ...
        public ReceiversController(PaymentContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Receiver != null ? 
                          ...
                          Problem("Entity set 'PaymentContext.Receiver'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Rec_Name,Rec_Phone,Rec_ID_NO,Rec_Dst_Acc")] Receiver receiver)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Rec_Name,Rec_Phone,Rec_ID_NO,Rec_Dst_Acc")] Receiver receiver)
        {
            if (id != receiver.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PaymentContext.Receiver'  is null.");
            }
            var receiver = await _context.Receiver.FindAsync(id);
            if (receiver != null)
            {
